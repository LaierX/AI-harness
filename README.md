...
- `v4.5.0`：新增 regression executor MVP，跑通 active rule / schema_validation / result artifact / evidence pointer
- `v4.5.1`：补强 rollback router、issue reuse、profile 升级规则、治理阻断条件与关键 schema valid examples

## 说明
- `README.md` 仅供人类快速查看，不作为执行体权威入口
- 执行体必须从 `00_INDEX.md` 开始装配模块
- `00_ENTRYPOINT_SINGLE_FILE.md` 仅作历史总版参考，不得被 prompt、cron、profile 或 runner 当作执行入口
